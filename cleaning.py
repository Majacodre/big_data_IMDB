...
def clean_data(train_csv: str, val_csv: str, test_csv: str, train_out: str, val_out: str, test_out: str):
    ...
    def apply_cleaning(df, medians: dict, split_name: str):
    ...
    train_clean = apply_cleaning(train, medians, "train")
    val_clean = apply_cleaning(val, medians, "val")
    test_clean = apply_cleaning(test, medians, "test")
